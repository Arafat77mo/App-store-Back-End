...
@section("title-side")
<a href="{{asset('admin/subcategory/create')}}" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
    <span>
...
<div class="m-portlet m-portlet--mobile col-md-12 col-sm-12 col-lg-12 col-auto">
    <form method="post" action="{{route('sub_category.update',$item->id)}}" enctype="multipart/form-data">
        @csrf
        @method("put")
        <div class='m-form'>
            <div class="m-portlet__body">
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="sub_name" value="{{$item->sub_name}}" class="form-control m-input" placeholder="ادخل الاسم ">
                            <span class="m-form__help">أدخل اسم التصنيف</span>
                        </div>
                    </div>
                    <div class="col-lg-4 m-form__group form-group">
                        <label class="col-lg-8 col-form-label">الاسم التصنيف الرئيسي</label>
                    ...
                    <td><img height=50 width=50
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6">
                                <input type="file" name="photo" value="{{($item->photo)}}" class="form-control m-input" >
